...
local colours = {
	...
	[39] = { r = 44, g = 109, b = 184, a = 255},
}


function Colour.GetHudFromBlipColour(blipColour)
	return colours[blipColour + 1]
end


function Colour.BlipWhite()
	return 0
end

function Colour.BlipRed()
	return 1
end


function Colour.BlipGreen()
	return 2
end


function Colour.BlipBlue()
	return 3
end


function Colour.BlipYellow()
	return 5
end


function Colour.BlipOrange()
	return 17
end


function Colour.BlipPurple()
	return 19
end


function Colour.BlipGrey()
	return 20
end


function Colour.BlipBrown()
	return 21
end


function Colour.BlipPink()
	return 23
end


function Colour.BlipLightBlue()
	return 26
end


function Colour.BlipDarkBlue()
	return 38
end
